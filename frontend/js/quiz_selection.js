        ...
        .map(
            (quiz, idx) => `
                <div class="quiz-card">
                    ...
                    <div class="quiz-meta">
                        <div>
                            <span class="badge badge-${quiz.difficulty.toLowerCase()}">${quiz.difficulty
                }</span>
                        </div>
                        <div>Grade ${quiz.grade}</div>
                    </div>
                    <div class="quiz-description">${quiz.subject} | ${quiz.questions
                } Questions</div>
                    <div class="quiz-info">
                        <span><i class="fa-solid fa-question"></i> ${quiz.questions
                } Questions</span>
